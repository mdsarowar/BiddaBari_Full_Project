...
{{--        var pdf = new PDFAnnotate("pdf-container", "{{ !empty($sectionContent->pdf_link) ? $sectionContent->pdf_link : asset($sectionContent->pdf_file) }}", {--}}
    @if(isset($sectionContent) )
        var pdf = new PDFAnnotate("pdf-container", "{{ !empty($sectionContent->featured_pdf) ? asset($sectionContent->featured_pdf) : '' }}", {
            @elseif(isset($product) && !empty($product->featured_pdf))
