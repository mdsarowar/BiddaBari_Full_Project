<form action="{{ route('batch-exam-routines.store') }}" method="post" enctype="multipart/form-data" id="coursesForm">
    <input type="hidden" name="batch_exam_id" value="{{ request()->input('batch_exam_id') }}" />
    @csrf
    <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Create Batch Exam Routine</h5>
        ...
        <div class="card card-body">
            <div class="row mt-2">
                ...
                <div class="col-md-4 mt-3">
                    ...
                    <div class="material-switch">
                        <input id="someSwitchOptionInfox" name="is_fack" type="checkbox" checked />
