                        ...
                        <div class="col-lg-12 col-md-12 col-xl-6">
                            <div class="d-flex flex-wrap align-items-center">
                                <div class="profile-img-main rounded">
                                    <img src="{{ !empty($userDetails->image) ? asset($userDetails->image) : 'https://w7.pngwing.com/pngs/178/595/png-transparent-user-profile-computer-icons-login-user-avatars-thumbnail.png' }}" alt="img" class="m-0 p-1 rounded hrem-6" style="height: 90px; width: 90px;" />
                                </div>
                                <div class="ms-4">
                                    <h4>{{ !empty($userDetails) ? $userDetails->first_name.' '.$userDetails->last_name : $user->name }}</h4>
                                    <p class="text-muted mb-2">Member Since: {{ \Illuminate\Support\Carbon::parse($user->created_at)->format('F Y') }}</p>
{{--                                    <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-rss"></i> Follow</a>--}}
                                    <a href="mailto:{{ $user->email }}" class="btn btn-secondary btn-sm"><i class="fa fa-envelope"></i> E-mail</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-xl-6">
                        ...
                        <div class="card-body p-0">
                            @if(!empty($userDetails))
                                <div class="p-5">
                                    ...
                                    <p>{!! $userDetails->description ?? 'No Description Uploaded Yet.' !!}</p>
                                </div>
                            @endif
                            ...
                            <div class="table-responsive p-5">
                                ...
                                <table class="table row table-borderless">
                                    ...
                                    <tr>
                                        <td><strong>Full Name :</strong> {{ !empty($userDetails) ? $userDetails->first_name.' '.$userDetails->last_name : $user->name }}</td>
                                    </tr><tr>
...
{{--                                    </tr>--}}
                                    ...
                                    <tr>
                                        <td><strong>Website :</strong> {{ !empty($userDetails) ? $userDetails->website : 'biddabari.com' }}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Location :</strong> Bangladesh</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                                        ...
                                        <div class="main-profile-contact-list">
                                            <div class="media mx-2">
                                                ...
                                                <div class="media-body ms-2">
                                                    ...
                                                    <p class="mb-0"> {{ !empty($userDetails) ? $userDetails->present_address : '' }} </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="main-profile-contact-list">
                                                    <div class="media mx-2">
                                                        ...
                                                        <div class="media-body ms-1">
                                                            ...
                                                            <p class="mb-0"> <a href="{{ $userDetails->github }}" class="text-default">{{ $userDetails->github }}</a> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="main-profile-contact-list">
                                                    <div class="media mx-2">
                                                        ...
                                                        <div class="media-body ms-2">
                                                            ...
                                                            <p class="mb-0"> <a href="{{ $userDetails->twitter }}" class="text-default">{{ $userDetails->twitter }}</a> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="main-profile-contact-list">
                                                    <div class="media mx-2">
                                                        ...
                                                        <div class="media-body ms-2">
                                                            ...
                                                            <p class="mb-0"> <a href="{{ $userDetails->linkedin }}" class="text-default">{{ $userDetails->linkedin }}</a> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="tab-pane" id="editProfile">
                    <div class="card">
                        <div class="card-body border-0">
                            <form class="form-horizontal" action="{{ route('users.update', auth()->id()) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                @if($userType == 'student')
                                    <input type="hidden" name="student_id" value="{{ !empty($userDetails) ? $userDetails->id : '' }}" />
                                @elseif($userType == 'teacher')
                                    <input type="hidden" name="teacher_id" value="{{ !empty($userDetails) ? $userDetails->id : '' }}" />
                                @endif
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-12 col-lg-12 col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="firstname" name="first_name" placeholder="First Name" value="{{ !empty($userDetails) ? $userDetails->first_name : '' }}">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-lg-12 col-xl-6">
                                        <div class="form-group">
                                            <label for="lastname" class="form-label">last Name</label>
                                            <input type="text" class="form-control" id="lastname" placeholder="Last Name" name="last_name" value="{{ !empty($userDetails) ? $userDetails->last_name : '' }}">
                                        </div>
                                    </div>
{{--                                    <div class="col-md-12 col-lg-12 col-xl-6">--}}
{{--                                        <div class="form-group">--}}
...
{{--                                    </div>--}}
                                    @if($userType == 'teacher')
                                        <div class="col-md-12 col-lg-12 col-xl-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="designation" placeholder="Designation" readonly value="Teacher" />
                                            </div>
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="form-group ">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="website" placeholder="Website" name="website" value="{{ !empty($userDetails) ? $userDetails->website : '' }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="phoneNumber" placeholder="phone number" readonly name="mobile" value="{{ !empty($user) ? $user->mobile : '' }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
                                ...
                                @if($userType == 'teacher')
                                    <div class="form-group ">
                                        <div class="row row-sm">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="" placeholder="Subject" name="subject" value="{{ !empty($userDetails) ? $userDetails->subject : '' }}">
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                <div class="form-group ">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control" id="address"  rows="2" name="present_address" placeholder="Address">{!! !empty($userDetails) ? $userDetails->present_address : '' !!}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="twitter" placeholder="twitter" name="twitter" value="{{ !empty($userDetails) ? $userDetails->twitter : '' }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="facebook" placeholder="facebook" name="facebook" value="{{ !empty($userDetails) ? $userDetails->facebook : '' }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="linkedin" placeholder="linkedin" name="linkedin" value="{{ !empty($userDetails) ? $userDetails->linkedin : '' }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="github" placeholder="github" name="github" value="{{ !empty($userDetails) ? $userDetails->github : '' }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control" id="biographicalInfo" rows="4" name="description" placeholder="">{!! !empty($userDetails) ? $userDetails->description : '' !!}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
...
{{--                                            <div class="main-img-user"><img alt="" class="rounded-circle avatar-md" src="{{ asset('/') }}backend/assets/images/faces/6.jpg"></div>--}}
{{--                                        </div>--}}
{{--                                        <div class="media-body">--}}
...
{{--                                    <div class="row row-sm">--}}
{{--                                        <div class="col">--}}
{{--                                            <img alt="img" class="h-200 mb-2 mt-2 me-4 br-5" src="{{ asset('/') }}backend/assets/images/media/timeline1.jpg">--}}
{{--                                            <img alt="img" class="h-200 br-5" src="{{ asset('/') }}backend/assets/images/media/timeline2.jpg">--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
...
{{--                                    <div class="row row-sm">--}}
{{--                                        <div class="col">--}}
{{--                                            <img alt="img" class="h-200 mb-2 mt-2 me-4 br-5" src="{{ asset('/') }}backend/assets/images/media/timeline3.jpg">--}}
{{--                                            <img alt="img" class="h-200 br-5" src="{{ asset('/') }}backend/assets/images/media/timeline4.jpg">--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                    <div class="media mt-4 profile-footer align-items-center">--}}
{{--                                        <div class="avatar-list avatar-list-stacked me-4">--}}
...
{{--                                    <div class="row row-sm">--}}
{{--                                        <div class="col">--}}
{{--                                            <img alt="img" class="h-200 mb-2 mt-2 me-4 br-5" src="{{ asset('/') }}backend/assets/images/media/timeline5.jpg">--}}
{{--                                            <img alt="img" class="h-200 br-5" src="{{ asset('/') }}backend/assets/images/media/timeline6.jpg">--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                    <div class="media mt-4 profile-footer align-items-center">--}}
{{--                                        <div class="avatar-list avatar-list-stacked me-4">--}}
...
{{--                                    <div class="row row-sm">--}}
{{--                                        <div class="col">--}}
{{--                                            <img alt="img" class="h-200 mb-2 mt-2 me-4 br-5" src="{{ asset('/') }}backend/assets/images/media/timeline7.jpg">--}}
{{--                                            <img alt="img" class="h-200 br-5" src="{{ asset('/') }}backend/assets/images/media/timeline9.jpg">--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                    <div class="media mt-4 profile-footer align-items-center">--}}
{{--                                        <div class="avatar-list avatar-list-stacked me-4">--}}
...
{{--                        <div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/assets/images/media/8.jpg" data-src="{{ asset('/') }}backend/assets/images/media/8.jpg">--}}
{{--                            <a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{ asset('/') }}backend/assets/images/media/8.jpg" alt="banner image"></a>--}}
{{--                        </div>--}}
{{--                        <div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/assets/images/media/10.jpg" data-src="{{ asset('/') }}backend/assets/images/media/10.jpg">--}}
{{--                            <a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{ asset('/') }}backend/assets/images/media/10.jpg" alt="banner image "></a>--}}
{{--                        </div>--}}
{{--                        <div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/assets/images/media/11.jpg" data-src="{{ asset('/') }}backend/assets/images/media/11.jpg">--}}
{{--                            <a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{ asset('/') }}backend/assets/images/media/11.jpg" alt="banner image "></a>--}}
{{--                        </div>--}}
{{--                        <div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/assets/images/media/12.jpg" data-src="{{ asset('/') }}backend/assets/images/media/12.jpg">--}}
{{--                            <a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{ asset('/') }}backend/assets/images/media/12.jpg" alt="banner image "></a>--}}
{{--                        </div>--}}
{{--                        <div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/assets/images/media/13.jpg" data-src="{{ asset('/') }}backend/assets/images/media/13.jpg">--}}
{{--                            <a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{ asset('/') }}backend/assets/images/media/13.jpg" alt="banner image"></a>--}}
{{--                        </div>--}}
{{--                        <div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/assets/images/media/14.jpg" data-src="{{ asset('/') }}backend/assets/images/media/14.jpg">--}}
{{--                            <a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{ asset('/') }}backend/assets/images/media/14.jpg" alt="banner image"></a>--}}
{{--                        </div>--}}
{{--                        <div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/assets/images/media/15.jpg" data-src="{{ asset('/') }}backend/assets/images/media/15.jpg">--}}
{{--                            <a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{ asset('/') }}backend/assets/images/media/15.jpg" alt="banner image"></a>--}}
{{--                        </div>--}}
{{--                        <div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/assets/images/media/16.jpg" data-src="{{ asset('/') }}backend/assets/images/media/16.jpg">--}}
{{--                            <a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{ asset('/') }}backend/assets/images/media/16.jpg" alt="banner image"></a>--}}
{{--                        </div>--}}
{{--                        <div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/assets/images/media/17.jpg" data-src="{{ asset('/') }}backend/assets/images/media/17.jpg">--}}
{{--                            <a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{ asset('/') }}backend/assets/images/media/17.jpg" alt="banner image"></a>--}}
{{--                        </div>--}}
{{--                        <div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/assets/images/media/18.jpg" data-src="{{ asset('/') }}backend/assets/images/media/18.jpg">--}}
{{--                            <a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{ asset('/') }}backend/assets/images/media/18.jpg" alt="banner image"></a>--}}
{{--                        </div>--}}
{{--                        <div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/assets/images/media/19.jpg" data-src="{{ asset('/') }}backend/assets/images/media/19.jpg">--}}
{{--                            <a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{ asset('/') }}backend/assets/images/media/19.jpg" alt="banner image"></a>--}}
{{--                        </div>--}}
{{--                        <div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/assets/images/media/20.jpg" data-src="{{ asset('/') }}backend/assets/images/media/20.jpg">--}}
{{--                            <a href="#"><img class="img-fluid wp-100 br-5" src="{{ asset('/') }}backend/assets/images/media/20.jpg" alt="banner image"></a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
...
{{--                                    </div>--}}
{{--                                    <a href="#">--}}
{{--                                        <img alt="avatar" class="avatar avatar-xl rounded" src="{{ asset('/') }}backend/assets/images/faces/1.jpg">--}}
...
{{--                                    </div>--}}
{{--                                    <a href="#">--}}
{{--                                        <img alt="avatar" class="avatar avatar-xl rounded" src="{{ asset('/') }}backend/assets/images/faces/11.jpg">--}}
...
{{--                                    </div>--}}
{{--                                    <a href="#">--}}
{{--                                        <img alt="avatar" class="avatar avatar-xl rounded" src="{{ asset('/') }}backend/assets/images/faces/12.jpg">--}}
...
{{--                                    </div>--}}
{{--                                    <a href="#">--}}
{{--                                        <img alt="avatar" class="avatar avatar-xl rounded" src="{{ asset('/') }}backend/assets/images/faces/5.jpg">--}}
...
{{--                                    </div>--}}
{{--                                    <a href="#">--}}
{{--                                        <img alt="avatar" class="avatar avatar-xl rounded" src="{{ asset('/') }}backend/assets/images/faces/7.jpg">--}}
...
{{--                                    </div>--}}
{{--                                    <a href="#">--}}
{{--                                        <img alt="avatar" class="avatar avatar-xl rounded" src="{{ asset('/') }}backend/assets/images/faces/13.jpg">--}}
...
{{--                                    </div>--}}
{{--                                    <a href="#">--}}
{{--                                        <img alt="avatar" class="avatar avatar-xl rounded" src="{{ asset('/') }}backend/assets/images/faces/8.jpg">--}}
...
{{--                                    </div>--}}
{{--                                    <a href="#">--}}
{{--                                        <img alt="avatar" class="avatar avatar-xl rounded" src="{{ asset('/') }}backend/assets/images/faces/4.jpg">--}}
